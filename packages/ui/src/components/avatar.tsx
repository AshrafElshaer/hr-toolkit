...
const avatarGroupStyles = cva(
  "flex items-center justify-center -space-x-2 [&_[data-slot=avatar]]:ring-2 [&_[data-slot=avatar]]:ring-bg",
);
...
const avatarBadgeStyles = cva(
  ["size-3 z-10 absolute bottom-0 right-0 rounded-full   bg-background"],
  {
    variants: {
      size: {
